...
namespace Playfair_Cipher
{
    class Program
    {
        ...
        {
            Console.Write("Enter a plaintext : ");
            string plainText = Console.ReadLine();
            Console.Write("\n\nEnter a key : ");
            string myKey = Console.ReadLine();
            string cipherText = Encipher(plainText, myKey);

            Console.Write("\nEnctypted Text : " + cipherText);
            string decipherText = Decipher(cipherText, myKey);
            Console.Write("\n\nDectypted Text : " + decipherText);
        ...
        private static List<int> FindAllOccurances(string str, char value)
        {
        ...
        private static char[,] GenerateKeySquare(string key)
        {
            ...
            for(int i = 0; i < 25; ++i)
            {
                List<int> indexes = FindAllOccurances(tempKey, defaultKeySquare[i]);
